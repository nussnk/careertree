...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php
    ...
    $content['field_company_logo']['#prefix'] = '<div class="my-table"><div class="my-left-wrapper"><div class="my-first-wrapper">';
    $content['field_company_name']['#suffix'] = '</div>';
    $my_post_date = format_date($created,'custom','F j, Y');
